...
$result=$fyAction->getZlFyList();
?>

<div id="center">
  <div id="fysm"> <span class="blu">租房</span>&nbsp;>&nbsp;共<span class="org"><?php echo $result["rows"]?></span>套在租房源 </div>
  ...
  <div id="main_box_img"> <a href="zlfy_detail.php?id=<?php echo $rs["ID"]?>" target="_blank">
  <img src="<?php echo getPicWithFirst($rs["TITLE_PHOTO"],$rs["PHOTO"],ZW_FY_L);?>" width="172" height="134" /> </a></div>
      <div id="main_box_tex">
      	<div id="tit_tex">
       	<a href="zlfy_detail.php?id=<?php echo $rs["ID"]?>" id="db_title_<?php echo $i;?>" target="_blank"><b><?php echo $rs["TITLE"]?></a></b> </div>
        <div id="tex1">
          <ul>
          	<li class="one">
            ...
            <li class="two" id="db_price_<?php echo $i;?>"><span style="font-size:20px;font-weight:bold;"><?php echo numberFormatBySelf($rs["PRICE"])?></span><span style="font-size:12px;">元/月</span></li>
        ...
        <div>
        <div class="time"><?php echo $rs["FBDATE"]?>发布</div>
        <?
        ...
        ?> 
        <a href="zlfy_detail.php?id=<?php echo $rs["ID"]?>" target="_blank"><div class="ckxq" id="ckx2" style="display:none;">查看详情&gt;&gt;</div></a>
        </div>        
      </div>
