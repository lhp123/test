...
?>
  <script type="text/javascript">
  	...
  	var M = "&mohu=<?=$mohu?>";
  	var DATA_URL="getxflist.php?action=xfsearch";
	var QYURL="xflist.php?1=1"+P+M;
	var PURL="xflist.php?1=1"+QY+M;
	var yewu = "xf";
     ...
     <div class="list_header_container">
      <div id="list_header">
       ...
       <div class="H"  id="topbar">
        ...
        <span id="list_title" class="title">新房列表</span>
        <div class="s1" style="display: block">
         <input type="text" autocomplete="off" id="list_search" value="<?=filterParaByName("mohu")!=""?filterParaByName("mohu"):"搜:区域/楼盘"?>">
...
<div id="like_list" style="display: none;" data-size="">
</div>
