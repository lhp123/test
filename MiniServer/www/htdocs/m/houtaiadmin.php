...
<html lang="en">
 <head>
	...
	<script type="text/javascript" src="netjs/houtaiadmin.min.js"></script>
 ...
 <div data-role="page">
	<div id="ht_content">
		...
		<div class="ht_middle">
			...
			<div class="menu">
				<ul class="menu_list">
					<li><a href="userlist.php" data-ajax="false">管理用户</a></li>
					<li><a href="usermsg.php" data-ajax="false">用户信息</a></li>
					<li><a href="changepsw.php" data-ajax="false">修改密码</a></li>
					<li><a href="msgmanage.php" data-ajax="false">产品管理</a></li>
					<li><a href="fabu.php" data-ajax="false">产品发布</a></li>
					<li><a href="mysharemenu.php" data-ajax="false">我的点击</a></li>
					<li><a href="sharemenu.php" data-ajax="false">所有点击</a></li>
					<li><a href="BIlist.php" data-ajax="false">后台分析</a></li>
				</ul>
			</div>
		</div>
	</div>
