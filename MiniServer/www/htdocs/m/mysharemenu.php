...
<html lang="en">
 ...
 <body id="indexPage">
	...
	<div data-role="header"><a href="houtai.php" class="ui-btn-left ui-btn ui-btn-inline ui-mini ui-corner-all ui-btn-icon-left ui-icon-home" data-ajax="false">主页</a><span class="ui-title"></span></div>
		<div id="in_list">
			<ul id="nav">
				<li><a href="mysharelist.php?type=1" data-ajax="false">一手楼</a><div class="right_1"><img src="netimages/louf.png"/></div></li>
				<li><a href="mysharelist.php?type=3" data-ajax="false">二手楼</a><div class="right_1"><img src="netimages/louf.png"/></div></li>
				<li><a href="mysharelist.php?type=2" data-ajax="false">周 全</a><div class="right_1"><img src="netimages/louf.png"/></div></li>
			</ul>
		</div>
	</div>
