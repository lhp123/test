    ...
    <div id="main_right_main_lb">
    	<table width="100%" border="0" cellpadding="0" cellspacing="0">
        	<tr>
            	...
            	<td width="100"  align="left" style="border-bottom:#333 1px inset;"><strong>联系人</strong></td>
                ...
                <td width="100"  align="left" style="border-bottom:#333 1px inset;"><strong>类型</strong></td>
                <td width="200"   align="left" style="border-bottom:#333 1px inset;"><strong>备注</strong></td>
            ...
            <?php
               ...
               // echo $wt->getSql();
            	...
            	while ( $rs = mysql_fetch_array ( $stmt ) ) {
            	    ...
            	    echo "<td   align='left' class='table_x' title='".$rs['LINKNAME']."'>".$rs[LINKNAME]."</td>";
