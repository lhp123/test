...
<img src="images/login_bg.jpg" width="100%" height="100%" /></div>
...
<div id="login">
	<form id="form1" name="form1" method="post" action="">
	  ...
	  <table width="90%" border="0" cellpadding="0" cellspacing="0">
    	    ...
    	    <tr>
    	      <td>
    	          <input value="" id = "tijiao" type="button" style="background-color: Transparent; background-image:url(images/submit2.jpg); width:107px; height:31px; border:0px; " onmouseover="this.style.backgroundImage='url(images/submit.jpg)'" onmouseout="this.style.backgroundImage='url(images/submit2.jpg)'" />
    	          <input value="" type="button" style="background-color: Transparent; background-image:url(images/res2.jpg); margin-left:63px; width:107px; height:31px; border:0px; " onmouseover="this.style.backgroundImage='url(images/res.jpg)'" onmouseout="this.style.backgroundImage='url(images/res2.jpg)'"/>
    	      </td>
    	    </tr>
	  </table>
	</form>
