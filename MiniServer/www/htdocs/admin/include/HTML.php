...
function echo_title_box1($title,$prefix,$params="",$flag = "1",$ifpri=1){
    echo "<div id='title_box1'>
        ...
        <table border='0' cellpadding='0' cellspacing='0'>
        	<tr>
            	<td valign='middle'><img src='".$GLOBALS["adminpath"]."images/ico2.png' width='16' height='20' style='margin-right:10px;'/></td>
...
function echo_title1 ($title){
    ...
    <div id='title1'>
        ...
        <table border='0' cellpadding='0' cellspacing='0'>
        	<tr>
            	<td valign='middle'><img src='".$GLOBALS["adminpath"]."images/ico3.png' width='22' height='22' style='margin-right:10px;' /></td>
