    	...
    	<table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            while ( $rs = mysql_fetch_array ( $stmt ) ) {
                ...
                if(ifHasPriL2("1PZGL_2PTPZ_3XG")){
               		...
               		echo "<A href='javascript:void(0);'><span class='db3'>子项目</span></a>&nbsp;&nbsp;";
                }
...
<table >
    ...
    <tr>
        <td width="80px">类型:</td>
        <td><input  name="TYPE" value="<?=$type ?>" type="text" readonly/></td>
    </tr>
    <tr>
        <td>名称:</td>
...
$(document).ready(function (){
    ...
    function dialog(){
		...
		var dialog = K.dialog({
			...
			yesBtn : {
				...
				click : function(e) {
					...
					$.post("<?=$page?>?action=save", $("#myform").serialize(),
							   function(data){
							       dialog.remove();
		...
		$("#main_right_main_lb table tr .db3").click(function(){
			window.parent.location.href="pz_sub_list.php?ptype=<?php echo $type;?>&type="+$(this).parents("tr").find("input[name='name']").val();
		});
