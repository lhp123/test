...
<div id="main">
  ...
  <div id="wz"><!-- <a href="<?php echo $page?>"><?php echo $title?></a>  --></div>
    <div id="title">
      ...
      <!-- 查询表单 -->
      <form id= "search" action="<?php echo $page?>?type=<?php echo $type?>" method="get">
    ...
    <div id="main_right_main_lb">
    	<table width="100%" border="0" cellpadding="0" cellspacing="0">
        	<tr>
                ...
                <td width="70"  align="left" style="border-bottom:#333 1px inset;"><strong>访问/点击</strong></td>
                <td width="110"  align=left style="border-bottom:#333 1px inset;"><strong>操作</strong></td>                
            </tr>
            <?php
            	...
            	while ( $rs = mysql_fetch_array ( $stmt ) ) {
            	    ...
            	    if(checkPriL2($pripj, $rs["USERID"])){
            	    	echo "<a href='fy_pj_list.php?action=lists&fyid=".$rs["ID"]."'><span>评</span></a>&nbsp;";
            	    }
            	    echo "</td>";
