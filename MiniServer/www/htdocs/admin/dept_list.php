...
<div id="main">
  ...
  <div id="main_right">
    ...
    <div id="title">
   	 <?php  echo_title_box1($title,$prefix,"",1,ifHasPriL2("1RSGL_2MDGL_3TJ")); ?>
    ...
    <div id="main_right_main_lb">
    	<table width="100%" border="0" cellpadding="0" cellspacing="0">
        	<tr>
                ...
                <td width="100"  align="left" style="border-bottom:#333 1px inset;"><strong>部门名称</strong></td>
                <td width="100"  align="left" style="border-bottom:#333 1px inset;"><strong>店长</strong></td>
                 <td width="100"  align="left" style="border-bottom:#333 1px inset;"><strong>电话</strong></td>
                <td width="150"  align="left" style="border-bottom:#333 1px inset;"><strong>地址</strong></td>
