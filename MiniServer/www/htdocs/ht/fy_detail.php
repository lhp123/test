    	...
    	<table width="100%" border="0" cellpadding="0" cellspacing="0">
        	<tr>
                ...
                <table>
                	<tr>
                    	<td width="35%">
                    	  &nbsp;标&nbsp;&nbsp;题&nbsp;：<input id="TITLE" name="TITLE" sname="TITLE" value="<?php echo $rs["TITLE"]?>"  type="text" class="inputcss" style="width:200px;" />
                    	</td>
                    	<td width="25%">
                    	    房屋编号：<input id="CONTRACT_CODE" name="CONTRACT_CODE" sname="CONTRACT_CODE" value="<?php echo $rs["CONTRACT_CODE"]?>" class="inputcss" type="text"  style="width:120px;" />
                        </td>
                            ...
                            <td width="35%">
                                          ...
                                          <input id="IF_JS" name="IF_JS" sname="IF_JS" <?php echo $rs["IF_JS"]=="1"?"checked":""?> value="<?php echo $rs["IF_JS"]?>" type="checkbox"  />急售
           ...
           <tr>
            <td >
                <table>
                	<tr>	
                		<td width="50%">
                                                                     所属小区： <select id="RE1" name="RE1" sname="RE1"  selt="<?php echo $rs["RE1"]?>"  class="selectcss"  style="width:80px;"/>
            	...
            	<td >
                	<table >
                    	<tr>
                          ...
                          <td  width="25%">
                        		梯户：<input id="TI" name="TI" sname="TI" value="<?php echo $rs["TI"]?>" type="text" class="inputcss" style="width:30px;" />梯&nbsp;
                        		<input id="HU" name="HU" sname="HU" value="<?php echo $rs["HU"]?>" type="text" class="inputcss" style="width:30px;" />户
                           </td>
                        <td width="50%" >
                   		                  户型：&nbsp;<input id="H_SHI" name="H_SHI" sname="H_SHI" value="<?php echo $rs["H_SHI"]?>"  class="inputcss" type="text" style="width:30px;" />室&nbsp;
               	  ...
               	  <table >
                    	<tr>
                         ...
                         <td  width="20%">
                          ...
                          <td  width="20%">
                        		&nbsp;均&nbsp;价：<input id="JUNJIA" name="JUNJIA" sname="JUNJIA" value="<?php echo $rs["JUNJIA"]?>" class="inputcss" type="text" style="width:50px;" />元/㎡
                          </td>
                          <?php if($type=="出售"){?>
                              <td  width="20%">
            ...
            <input id="USERNAME" name="USERNAME" sname="USERNAME"  value="<?php echo getUsername();?>" type="hidden" >
            <input id="USERID" name="USERID" sname="USERID" value="<?php echo getUserid();?>" type="hidden"/>           
            <tr>
            	<td >
                	<table >
                    	<tr>
