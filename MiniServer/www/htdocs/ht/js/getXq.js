    ...
    (function ($) {
        $.fn.extend({
        	...
        	getXq: function (options) {
             ...
             function getBody(seltRe1id1,seltRe1id2){
            	var o = options;
     			...
     			if(seltRe1id2!=""&&seltRe1id1!=""){
     				
         			for(var i = 0; i<json.length; i++){

         				if(seltRe1id2==json[i].PID){
                ...
                _this.click(function (){
         			var seltRe1id2 = $("#RE2 option:selected").attr("id");
         			var seltRe1id1 = $("#RE1 option:selected").attr("id");
         			body = getBody(seltRe1id1,seltRe1id2);
                	init();
                	handle();
                });
