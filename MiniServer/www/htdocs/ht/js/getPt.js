             ...
             function getBody(){
            	var o = options;
             	...
             	for(var i = 0; i<json.length; i++){
                 		...
                 		body = body+ "<td nowrap align='left'><input type='checkbox' "+(checked?"checked":"")+"  value='"+json[i].NAME+"'/><a href='javascript:void(0);' style='margin: 10px 10px;color:#0180B5;'>"+json[i].NAME+"</a></td>";
                 		checked = false;
