...
<ARTICLE 
id=waptool_B02_05 class=jsqmain style="width:74%; float:right;">
<?
$jmenu="zh";
...
<DL>
  <DT>公积金贷款总额 </DT>
  <DD>
  <DIV class=mr5><INPUT id=total_gjj class=jsqinput01 value=100 type=tel  name=total_gjj></DIV>
...
<DL>
  <DT>公积金贷款利率 </DT>
  <DD>
  	<DIV class=mr2><INPUT id=rate_gjj class=jsqinput02 value=4.50 type=tel  name=rate_gjj></DIV>
...
<DL>
  ...
  <DIV class=mr5>
  			<SELECT id=pix_rate class=jsqinput05 name=pix_rate> 
  				<OPTION  label=基准利率 selected value=0>基准利率</OPTION> 
  				<OPTION label=优惠30%  value=1>优惠30%</OPTION> 
  				<OPTION label=优惠15% value=2>优惠15%</OPTION> 
  				<OPTION label=上浮10% value=3>上浮10%</OPTION> 
  				<OPTION label=自定义  value=4>自定义</OPTION>
  			</SELECT>
  </DIV>
  <DIV class=mr2><INPUT id=rate_sy class=jsqinput02 value=6.55 type=tel name=rate_sy></DIV>
  <DIV style="FONT-SIZE: 14px">%</DIV>
   <!-- 
