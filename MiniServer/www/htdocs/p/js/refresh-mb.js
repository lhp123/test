...
function(J) {
	function f(e) {
		var t = J.isString(e) ? e: l(e),
		n = "?tp=error&site=" + o + "&v=" + (J.W.PHPVERSION || "") + "&msg=" + t; (new Image).src = i + n,
	...
	function l(e) {
		...
		function(n, r) {
			r in e && (r == "stack" ? t.push(r + ":" + u(e[r].split(/\n/)[0])) : t.push(r + ":" + u(e[r])))
		}),
		t.join(",")
	}
	function c(e) {}
	...
	n = J.D.location.host,
	r = /dev|test/.test(n),
	i = "http://" + (r ? t + e + "test": "m" + e + "com") + "/ts.html",
	s = n.match(/^(\w+)\.(\w+)\./),
	o = s ? s[1] === "m" ? "m": s[2] : "unknow",
...
function(J) {
	...
	function u() {
		var t, n = J.g("body");
		n && (n = n.attr("data-page")) && (t = e.url + "?pn=" + n + "&site=" + e.site + "&in=" + (J.iN || 0) + (r && r.navigationStart ? o() : s()), (new Image).src = t)
	}
	var e = J.logger,
	t = J.W,
	n = t.performance || {},
...
function(J) {
	...
	n.Tracker = function(r, s, o) {
		...
		function c(e) {
			var t = l(),
			r = ".com/st";
			e = e || "http://" + (n.isDev ? "soj.dev.aifang" + r: "s.anjuke" + r + "b");
			try {
				J[u.sendType || "post"]({
					url: e,
					type: "jsonp",
...
function(J) {
	...
	J.utils.uuid = function() {
		...
		n[8] = n[13] = n[18] = n[23] = "-",
		n[14] = "4";
		for (r = 0; r < 36; r++) n[r] || (i = 0 | Math.random() * 16, n[r] = t[r == 19 ? i & 3 | 8 : i]);
		return n.join("")
	}
} (J),
function(J) {
