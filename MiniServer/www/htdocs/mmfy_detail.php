...
<div id="center">
  ...
  <span class="blu"><a href="mmfy_list.php">二手房</a></span>&nbsp;&gt;&nbsp;

  <span class="blu"><a href="mmfy_list.php?re1=<?php echo $rs["RE1"];?>" target="_blank"><?php echo $rs["RE1"];?></a></span>&nbsp;&gt;&nbsp;

  <span class="blu"><a href="mmfy_list.php?re1=<?php echo $rs["RE1"];?>&re2=<?php echo $rs["RE2"];?>" target="_blank"><?php echo $rs["RE2"];?></a></span>&nbsp;&gt;&nbsp;
  ...
  <div id="xxy_tit">
    ...
    <table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="left" style="padding-left:10px; padding-right:10px;width:25px;"><img src="images/ico_sou.jpg" width="25" height="25" /></td>
    ...
    <div id="tit_main_tex">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td style="line-height:22px; padding-bottom:20px;"> 售价:<span class="org" style="font-size:16px; font-weight:bold;"><?php echo numberFormatBySelf($rs["PRICE"])?>万</span>/<?php echo numberFormatBySelf($rs["BUILD_AREA"])?>平米 <span style="margin-left:10px;" class="org">近1个月成交<?php echo $cjAction->getXqCjTaoshu_OneMonth($rs["DISID"])?>套</span><br />

            单价：<?php echo numberFormatBySelf($rs["JUNJIA"])?>元/平米 &nbsp;&nbsp;首付：<?php echo numberFormatBySelf($rs["SF_PRICE"])?>万 </td>

        </tr>

        <tr>

          <td style="line-height:22px; padding-bottom:20px;"> 房型:<?php echo $rs["H_SHI"]?>室<?php echo $rs["H_TING"]?>厅/<?php echo $rs["FITMENT"]?><br />

            朝向:<?php echo $rs["DIRECTION"]?><br />

            楼层:<?php echo getFloor($rs["TOP_FLOOR"],$rs["FLOOR"]);?><?php //echo $rs["TOP_FLOOR"]?><br />

            小区:<span class="blu"><a href="/xq/xq_detail.php?xqid=<?php echo $rs["DISID"]?>" target="_blank"><?php echo $rs["DISNAME"]?></a></span>/<?php echo $rs["JZ_YEAR"]?>年<?php echo $rs["FRAME"];?> &nbsp;&nbsp;<span class="blu"><a href="/xq/xq_fy_list.php?type=mm&xqid=<?php echo $rs["DISID"]; ?>"  target="_blank" ><?php echo $fyAction->getFyCountByDis($rs["DISID"],"出售");?>套出售中</a></span></td>

        </tr>

        <tr>

          <td style="line-height:22px; "> 房源评价：<span class="blu"><a href="#"><?php echo $pjAction->getPjCountByFy($fyid)?>条</a></span><br />            
  ...
  <div id="cjfy">
    ...
    <div id="cjfy_main" >
      ...
      <div><span style="font-size:14px;"><?php echo $rs["DISNAME"]?><?php echo date("m",time());?>月二手房成交<span class="org"><?php echo $cjAction->getXqCjTaoshu_CurMonth($rs["DISID"],"买卖")?></span>套，成交均价<span class="org"><?php echo round($cjAction->getXqCjJunjia_CurMonth($rs["DISID"],"买卖"))?></span>元/平米，环比上月<span class="org"><?php 
  ...
  <div id="fyjs_map">
    ...
    <div>
    		...
    		<iframe src="xq/xq_map_detail.php?xqid=<?php echo $rs["DISID"]?>&overlay=marker" name="map" id="map" width="1003px" height="251px" frameborder=0 scrolling=no marginheight=0 marginwidth=0></iframe>
        ...
        <div class="Cont" style="float:left;" id="ISL_Cont">
          ...
          <div class="ScrCont">
            ...
            <div id="List1"> 
              ...
              $result=$fyAction->getSimilarFy($fyid, 5,"出售");

              while($rsxs=mysql_fetch_array($result["result"])){

              ?>

              <div id="fyjs_xsfy_main_box1"> <a href="/mmfy_detail.php?id=<?php echo $rsxs["ID"]?>" target="_blank"><img src="<?php echo getPicWithFirst($rsxs["PHOTO"], $rsxs["FXT"], ZW_FY_L)?>" width="172" height="127" /> <br />
